            ...
            <div class="col-xs-12">
                ...
                <div id="carousel-example" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <?php
                        $r = 0;
                        foreach (array_chunk($featured_products, 16) as $fps) {
                            ?>
...
<!-- jorge flores
        ...
        luego agregar la imagen del boton de whapptzap a la carpeta de imagnes (assets/images/w.png)
        luego agregar la clase del css en el archivo assets/custom /shop.css
        
        
    -->
<div class="container-boton">
        <a href="https://wa.me/584145681386?text=Tengo%20una%20consulta%20sobre :" target="_blank">
            <img class="boton" src="assets/images/w.png" alt="">
        </a>
    </div>
