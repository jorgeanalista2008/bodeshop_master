        ...
        <div class="contents">
            <div class="text-center">
                <?php if ($Settings->logo2) {
                     echo '<a href="#"><img src="' . base_url('assets/uploads/logos/' . $Settings->logo2) . '" alt="' . $Settings->site_name . '" style="margin-bottom:10px;" /></a>';
   //  JORGE FLORES - SI QUIRES QUE VAYA LA WEB DE CATALOGO, DESCOMENTA ESTO Y COMENTA LA DE ARRIBA echo '<a href="../../"><img src="' . base_url('assets/uploads/logos/' . $Settings->logo2) . '" alt="' . $Settings->site_name . '" style="margin-bottom:10px;" /></a>';
} ?>
            </div>
    ...
    ?>
                     ...
                     <!-- jorge flores
                       ...
                       <div class="login-form-links link2 text-center">
                       <!-- jorge flores
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">
                            Dolar Banco central (BCV)
                        </button>
                         -->
                        </div>
                        <?php
    ...
    <script src="../../tasa/admin/js/tasa.js"></script>
