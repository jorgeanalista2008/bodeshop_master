...
<div id="app_wrapper">
    <header id="header" class="navbar">
        ...
        return basename($path);
                    ...
                    <li class="dropdown hidden-xs">
                        <a class="btn bdarkGreen tip" title="<?= lang('change_rate') ?>" data-toggle="modal" data-target="#exampleModal" data-placement="bottom" href="#">
                            <i class="fa fa-exchange"></i> <span class="padding05"><?= lang('change_rate') ?></span>
                        </a>
                    </li>
                    <?php
                            } ?>
                ...
                <div class="row">
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tasa de cambio</h5>
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">Tasa:</label>
                                    <input type="number" class="form-control tasa" id="tasa" required>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary guardarTasa">Guardar</button>
                        </div>
                        </div>
                    </div>
                </div>
