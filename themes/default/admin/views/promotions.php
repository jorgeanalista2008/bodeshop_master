        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">Ventas | DSD-Neo</h1>
                    <p class="lead">>Ventas | DSD-Neo , es un sistema web para mediana y gran empresa, permite llevar todo lo referente a un inventario, comrpas ventas, devoluciones, traslados y demás.</p>
                  
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>Ventas | DSD-Neo por:  <a href="https://jorge.mosqeudacordova.com">Jorge Flores</a>.</p>
                    </div>
                </div>
            </div>
        </div>
