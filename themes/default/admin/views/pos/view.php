...
<?php   $query = $this->db->query("SELECT * FROM sma_exchange_rate where id =1");
        $row = $query->row();
        if (isset($row)){
            $tasa_dolar = $row->tasa;          
        }
    ...
    <div id="wrapper">
        <div id="receiptData">
            ...
            <div id="receipt-data">
                ...
                <table class="table table-condensed">
                    ...
                    <tfoot>
                        ...
                        if ($pos_settings->rounding || $inv->rounding != 0) {
                            ...
                            <tr>
                                <th><?=lang('grand_total'); ?></th>
                                <th class="text-right">BS.D  <?=$return_sale ? ($inv->grand_total + $return_sale->grand_total) : $inv->grand_total*$tasa_dolar; ?></th>
                            </tr>
                            <?php
                        }
                ...
                <? echo '<p class="text-center">Tasa de Referencia BCV  '.$tasa_dolar. '</p>' ?>
