...
// cambios mosqueda
            tr_html =
                ...
                product_id +
                '"><input name="i" type="hidden" class="rid" value="' +
                product_i +
                '"><input name="f" type="hidden" class="rid" value="' +
                product_f +
                '"><input name="n" type="hidden" class="rid" value="' +
                product_n +
            ...
            tr_html +=
                ...
                '</span></td>';
                // cambios mosqueda
                // meter valor del dolar (jorge flores)
            tr_html +=
        ...
        let change_rate = $('#global_change_rate').first().text();
      //console.log(change_rate);
        $('#gtotal_bsd').text(formatMoney(gtotal*change_rate));
        if (pos_settings.remote_printing != 1) {
