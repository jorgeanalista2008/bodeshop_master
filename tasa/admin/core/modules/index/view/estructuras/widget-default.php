                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Inmuebles
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-12 data">
                        <p>Pólizas de Inmuebles</p>
                     
                        
                    </div>
                </div>
               <input type="hidden" id="dataPolizasEstructuras" class="dataPolizasEstructuras" value=''>
                <!-- Basic table -->
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic-polizas-estructuras table">
                                    <thead>
                                        <tr>
