  ...
  <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Automoviles
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
               ...
               <input type="hidden" id="dataPolizasAutos" class="dataPolizasAutos" value=''>
                <!-- Basic table -->
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic-polizas-autos table">
                                    <thead>
                                        <tr>
