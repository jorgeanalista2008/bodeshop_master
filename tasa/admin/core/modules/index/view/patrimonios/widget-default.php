            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Pólizas</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Patrimonial
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-12 data">
                        <p>Pólizas de patrimonio</p>
                     
                        
                    </div>
                </div>
               <input type="hidden" id="dataPolizasPatrimonios" class="dataPolizasPatrimonios" value=''>
                <!-- Basic table -->
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic-polizas-patrimonios table">
                                    <thead>
                                        <tr>
