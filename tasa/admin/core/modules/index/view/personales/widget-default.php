            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-12 data">
                        <p>Pólizas de personal</p>
                     
                        
                    </div>
                </div>
               <input type="hidden" id="dataPolizasPersonales" class="dataPolizasPersonales" value=''>
                <!-- Basic table -->
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic-polizas-personales table">
                                    <thead>
                                        <tr>
