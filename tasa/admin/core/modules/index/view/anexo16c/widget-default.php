            ...
            <div class="content-body">
                <section class="invoice-preview-wrapper" >
                    <div class="row invoice-preview">
                        <!-- Invoice -->
                        <div class="col-xl-12 col-md-12 col-12 anexo" id="anexo" >
                            <div class="card invoice-preview-card">
                                ...
                                <div class="text-center">
                                    ...
                                    <table class="table_anexos">
                                        <thead>
                                            <tr>
                                                <th class="th_anexos"></th>
                                                <th class="th_anexos">VIDA</th>
                                                <th class="th_anexos">RAMOS GENERALES</th>
                                                <th class="th_anexos">TOTALES</th>
                                            </tr>
                                           
                                        </thead>
                                             <tr>
                                                <th class="th_anexos">NRO DE CUENTA</th>
                                                <th class="th_anexos">6-61-01</th>
                                                <th class="th_anexos">6-61-02</th>
                                                <th class="th_anexos"></th>
                                            </tr>
                                        <tbody>
                                            <?php 
                                            ...
                                            <tr>
                                                <th class="td_anexos">Totales</th>
                                                <th class="td_anexos"><?php echo $totalv; ?></th>
                                                <th class="td_anexos"><?php echo $totalg; ?></th>
                                                <th class="td_anexos"><?php echo $total; ?></th>
                                            </tr>
                        ...
                        <div class="col-xl-12 col-md-12 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">
                                <button class="btn btn-primary w-100 mb-75 generarAnexo" id="generarAnexo">
                                    Generar pdf
                                    </button>                              
                                </div>
                            </div>
