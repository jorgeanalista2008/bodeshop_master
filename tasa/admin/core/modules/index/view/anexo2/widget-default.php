                    ...
                    <div class="row invoice-preview">
                        ...
                        <div class="col-xl-12 col-md-12 col-12" id="anexo1p" >
                            <div class="card invoice-preview-card">
                                <div class="card-body invoice-padding pb-0">
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        ...
                                        <div class="mt-md-0 mt-2">
                                            <h4 class="invoice-title">Anexo Nro. 2</h4>
                                            <div class="invoice-date-wrapper">
                                                <p class="invoice-date-title">Cuenta Nro.- 1-12</p>
                                ...
                                <div class="text-center">
                                                <p class="invoice-date-title">CUENTA ESPECIAL BANCARIA DE PRIMAS</p>
                        ...
                        <!-- /Invoice -->
                         ...
                         <div class="col-xl-12 col-md-12 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    <a href="index.php?action=anexo2" target="_blank" class="btn btn-primary w-100 mb-75">
                                    Generar pdf
                                            </a>                              
                                </div>
                            </div>
