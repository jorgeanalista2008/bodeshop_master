                        ...
                        <div class="col-xl-12 col-md-12 col-12" id="anexo1p" >
                            <div class="card invoice-preview-card">
                                <div class="card-body invoice-padding pb-0">
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        ...
                                        <div class="mt-md-0 mt-2">
                                            <h4 class="invoice-title">Anexo Nro. 7</h4>
                                            <div class="invoice-date-wrapper">
                                                <p class="invoice-date-title">Cuenta Nro.- (1-17) (1-17-01) (1-17-02) (1-17-03) (1-17-04)</p>
                                ...
                                <div class="text-center">
                                                <p class="invoice-date-title">GARANTIA DADA  A LA NACION</p>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th class="py-1">EMPRESA ASEGURADORA</th>
                                                <th class="py-1">NRO. DE FIANZA</th>
                                                <th class="py-1">RECIBO</th>
                                                <th class="py-1">SUMA ASEGURADA</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
