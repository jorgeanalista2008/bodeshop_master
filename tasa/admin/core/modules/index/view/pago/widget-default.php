        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Pago</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Pago
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <div id="user-profile">
                    ...
                    <input type="hidden" id="codigoPago" value ="<?php echo $_GET['codigoPago']; ?>">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form class="form update-record-pago"  id="datosPago">
                                                    <div class="row">
                                                        <div class="col-md-6 col-12">
                                                            <div class="mb-1">
                                                            <input type="text" class="form-control  codigo-pago" name="codigo-pago"  id="codigo-pago" />
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            ...
                                                            <input type="number" class="form-control  cuota-pago" name="cuota-pago" placeholder="" id="cuota-pago" readonly="readonly"  />
                                                            </div>
                                                        </div>                                                      
                                                        <div class="col-md-6 col-12">
                                                            <div class="mb-1">
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <button type="button" class="btn btn-info me-1 data-submit-pago-update">Editar</button>
                                                            <button type="button" class="btn btn-danger me-1 data-submit-pago-delete-fuera">Eliminar</button>                                                        
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
