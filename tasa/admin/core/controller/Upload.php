<?php
        class  Media {
          ...
          public $userPath = 'storage/media';
          public $productPath = 'storage/media';
          public $errors = array();
        ...
        /*--------------------------------------------------------------*/
          private function insert_media(){
                 global $db;
                 $sql  = "INSERT INTO media (nombre,image )";
                 $sql .=" VALUES ";
                 $sql .="(
                          '{$this->fileName}',
                          '{$this->fileType}'
        ...
        /*--------------------------------------------------------------*/
           public function media_destroy($id,$file_name){
             ...
             if(unlink($this->productPath.'/'.$this->fileName)){                
                 return true;
             } else {
