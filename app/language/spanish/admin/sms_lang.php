...
$lang['sale_added']       = 'Estimado {customer}, Su pedido (Ref. {sale_reference}) ha sido recibido, por favor proceda al pago del importe {grand_total}. gracias';
...
$lang['delivering']       = 'Estimado {customer}, Estamos entregando tu pedido (Ref. {delivery_reference}).';
