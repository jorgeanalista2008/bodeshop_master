                    ...
                    <div class="row invoice-add">
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        <div>
                                            <div class="logo-wrapper">                                                
                                                <h3 class="text-primary invoice-logo">Nota de Devoluciòn</h3>
                                            </div>
                                        ...
                                        <div class="invoice-number-date mt-md-0 mt-2">
                                            ...
                                            <span class="title">Devolución:</span>
                                                <div class="input-group input-group-merge invoice-edit-input-group">
                                                    ...
                                                    <input type="text" class="form-control invoice-edit-input txtAddEntrada_codigoEntrada" placeholder=""  />
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-3 col-md-4 col-12">
                            <div class="card">
                                <div class="card-body">      
                                    <div class="logo-wrapper">                                                
                                                <h4 class="text-info ">Datos de Devolución</h4>
                                            </div>
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control txtAddDevMotivo"  id="txtAddDevMotivo" name="txtAddDevMotivo" type="text" placeholder="" />
                                    </div>    
                                    ...
                                    <button type="button" class="btn btn-success w-100  btnAddDevolucion">  
