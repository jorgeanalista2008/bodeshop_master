                        ...
                        <div class="modal-dialog sidebar-sm">
                            <form class="add-new-record modal-content pt-0">
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-icon-default-email">Nombre Usuario</label>
                                        <input type="text" class="form-control  nombreUsuario" name="nombreUsuario" placeholder="usuario" id="nombreUsuario" />
                                    </div>     
