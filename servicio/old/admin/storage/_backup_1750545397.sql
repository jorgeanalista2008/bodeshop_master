...
CREATE TABLE `asignacion` (
  ...
  `tipoCustodio` int(11) NOT NULL COMMENT '1-PERSONAL 2-DEPENDENCIA',
...
INSERT INTO cargo VALUES("1","TECNICO DE SERVICIO","","1");
INSERT INTO cargo VALUES("2","RECEPCIONISTA","","1");
...
INSERT INTO cliente VALUES("1","V-6330549","FERREFACIL","2","+5841251902","GODOYCISNEROSA@HOTMAIL.COM","1005","CALLE 8 ENTRE 7 Y 8, SECTOR ZUMUCO","1");
...
INSERT INTO empresa VALUES("1","01","Emprediemiento Yarauy","soporte@guslaya.com","Av Caracas entre 3era y 4ta, San Felipe, Yaracuy","04145681386","J-132456789J","logo.webp","1");
...
CREATE TABLE `mantenimiento` (
  ...
  `tipoMantenimiento` int(11) NOT NULL COMMENT '1-CORRECTIVO 2-PREVENTIVO',
  `observacion` text NOT NULL,
...
INSERT INTO marca VALUES("1","1","HP","1");
...
INSERT INTO modelo VALUES("1","1","DESKTOP","1");
...
CREATE TABLE `ordenes` (
  ...
  `idVehiculo` int(11) NOT NULL,
  `idPersonal` int(11) NOT NULL,
  `idPersonalAcargo` int(11) NOT NULL,
  ...
  `estatus` int(11) NOT NULL COMMENT '1-activa 2-completada 0-inactiva',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO personal VALUES("1","V-16291682","GINETH ANDREINA MICARELLI POLANCI","1","","041411111","TECNICO1@GUSLAYA.COM","1005","1","URB SAN ANTONIO","1");
...
INSERT INTO tipo VALUES("1","CPU","2","0");
INSERT INTO tipo VALUES("2","DESTOKP","2","1");
INSERT INTO tipo VALUES("3","PORTATIL","2","1");
INSERT INTO tipo VALUES("4","CRHOMEBOOK","2","1");
INSERT INTO tipo VALUES("5","REFURBISHED","2","1");
INSERT INTO tipo VALUES("6","PC HIBRIDO","2","1");
...
INSERT INTO ubicacion VALUES("1","ESTANTE DE TECNICO","ESTANTE DE DOS PUERTAS PARA TECNICO","1");
INSERT INTO ubicacion VALUES("2","ESTANTE EXIBIHIDOR","EXTANTE TIPO RACK","1");
...
INSERT INTO user VALUES("1","Administrador sistema","soporte@guslaya.com","f25708ac12fdb3c7e6b1a6bf619a80fd140e2a9d","1","../admin/storage/archivos/admin.png","0000-00-00 00:00:00","1","1","0000-00-00 00:00:00","0","1");
