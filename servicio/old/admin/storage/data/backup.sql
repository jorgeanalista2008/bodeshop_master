...
-- Tiempo de generación: 20-06-2025 a las 21:54:17
...
CREATE TABLE IF NOT EXISTS `articulo` (
  ...
  `unidadMedida` int NOT NULL COMMENT '1- UNIDAD\r\n2- CENTIMETROS\r\n3- METROS\r\n4- MILILITROS\r\n5- LITROS\r\n6- GRAMOS\r\n7- KILOS',
  `cantidad` int NOT NULL,
  `condicion` int NOT NULL COMMENT '1-SIN ASIGNACION 2-ASIGNADO',
...
CREATE TABLE IF NOT EXISTS `asignacion` (
  ...
  `tipoCustodio` int NOT NULL COMMENT '1-PERSONAL 2-DEPENDENCIA',
  `idCustodio` int NOT NULL,
...
INSERT INTO `cargo` (`id`, `cargo`, `descripcion`, `estatus`) VALUES
(1, 'TECNICO', '', 1);
...
INSERT INTO `empresa` (`id`, `co_emp`, `name`, `email`, `dir`, `telefonos`, `rif`, `image`, `estatus`) VALUES
(1, '01', 'EMPRESA ', 'soporte@guslaya.com', 'DIRECCION EMPRESA', ' 5841211223344', 'J-132456789', 'logo.webp', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `empresamail`
--

DROP TABLE IF EXISTS `empresamail`;
CREATE TABLE IF NOT EXISTS `empresamail` (
  `id` int NOT NULL AUTO_INCREMENT,
  `co_emp` varchar(100) NOT NULL,
  `text` text NOT NULL,
...
--
-- Volcado de datos para la tabla `empresamail`
--

INSERT INTO `empresamail` (`id`, `co_emp`, `text`, `smtp`, `password`, `host`, `port`) VALUES
(1, '01', 'TEXTO DE PRUEBA DE ENVIO DE MENSAJES JGFIXPRO', 'smtp.gmail.com', 'okkdhhzwutqzcyhm', 'smtp.gmail.com', '587');
...
CREATE TABLE IF NOT EXISTS `entradadetalle` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `condicion` int NOT NULL COMMENT '1-DISPONIBLE 2-EN MANTENIMIENTO 3-EN DESCARTE 4-DE COMISIÓN 4-ASIGNADO',
  `estatus` int NOT NULL COMMENT '1- ACTIVO 0-INACTIVO',
...
CREATE TABLE IF NOT EXISTS `mantenimiento` (
  ...
  `tipoMantenimiento` int NOT NULL COMMENT '1-CORRECTIVO 2-PREVENTIVO',
  `observacion` text NOT NULL,
  `fechaProximoMantenimiento` date NOT NULL,
  `estatus` int NOT NULL COMMENT '1-completado 2-en curso 0-inactivo',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `marca` (`id`, `idTipo`, `marca`, `estatus`) VALUES
(1, 1, 'HP', 1);
...
INSERT INTO `modelo` (`id`, `idMarca`, `modelo`, `estatus`) VALUES
(1, 1, 'DESKTOP', 1);
...
CREATE TABLE IF NOT EXISTS `ordenes` (
  ...
  `20` int NOT NULL,
  `otro` int NOT NULL,
  `estatus` int NOT NULL COMMENT '1-activa 2-completada 0-inactiva',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `ordentrabajo` (
  ...
  `fechaSalida` date NOT NULL,
  `descripcion` text NOT NULL,
  `condicion` int NOT NULL COMMENT '1= en espera 2= completadas 3=en proceso 4 = a destiempo',
  `estatus` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Estructura de tabla para la tabla `ordentrabajodetalles`
--

DROP TABLE IF EXISTS `ordentrabajodetalles`;
CREATE TABLE IF NOT EXISTS `ordentrabajodetalles` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `personal` (
  ...
  `nombreCompleto` varchar(100) NOT NULL,
  `genero` int NOT NULL COMMENT '1-FEMENINO 2-MASCULINO',
...
CREATE TABLE IF NOT EXISTS `salida` (
  ...
  `codigoSalida` varchar(100) NOT NULL,
  `observacion` text NOT NULL,
  `estatus` int NOT NULL COMMENT '1=ACTIVO 0=INACTIVO 2=DEVUELTO',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `salidadetalle` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tipo` (`id`, `tipo`, `condicion`, `estatus`) VALUES
(1, 'CPU', '2', 1);
...
INSERT INTO `ubicacion` (`id`, `ubicacion`, `descripcion`, `estatus`) VALUES
(1, 'ESTANTE-101-01', 'ESTANTE AL LADO DEL LA PUERTA PRINICPAL', 1),
(2, 'SEGUNDO_PISO', 'SUCCESS', 1);
...
(1, 'Administrador sistema', 'soporte@guslaya.com', 'c91ac6c7b6748b56f499ff298da433049b7ca581', 1, '../admin/storage/archivos/admin.png', '0000-00-00 00:00:00', 1, 1, '0000-00-00 00:00:00', 0, 1);
