      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $opcion_estado = full['condicion'];
            var $estatus = {
              1: { title: 'EN ESPERA DE ASIGNACION', class: 'badge-light-info' },
              2: { title: 'COMPLETADA', class: ' badge-light-info' },
              3: { title: 'EN PROCESO', class: ' badge-light-info' },
        ...
        {   // Actions
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="'+ full['codigo'] + '*' + full['idItem'] + ' dropdown-item activar-record ">' +
              feather.icons['power'].toSvg({ class: 'font-small-4 me-50' }) +
              'Cerrar</a>' +
              '<a href="index.php?action=reportes&tipo=1&accion=1&datos=1&id=' + full['codigo'] + '" target="_blank" class="dropdown-item">' +
              feather.icons['eye'].toSvg({ class: 'font-small-4 me-50' }) +
              'Ver</a>' +
              '</div>' +
              '</div>'
          ...
          buttons: [
            {
              ...
              text: feather.icons['printer'].toSvg({ class: 'font-small-4 me-50' }) + 'Imprimir',
              className: 'dropdown-item',
              exportOptions: { columns: [2,3,4, 6, 8,9] }
            },
            {
              extend: 'excel',
              text: feather.icons['file'].toSvg({ class: 'font-small-4 me-50' }) + 'Excel',
...
$('.btnCorreoEditar').on('click', function () {
  ...
  if (($text != '') && ($smtp!='') && ($password!='')  && ($host!='') && ($port!='') ) { 
    ...
    if ($('.clientesRegistrados').length) {
      var $orderChart = document.querySelector('#order-chart-clientes');  
      var orderChart;
  ...
  if ($('.ordenesCompletadas').length) {
    var $graficoComision = document.querySelector('#order-chart-comision');  
    var graficoComision;
    var comisionGraficoOpciones;
    comisionGraficoOpciones = {
      chart: {
        height: 100,
        type: 'area',
        toolbar: {
    ...
    graficoComision = new ApexCharts($graficoComision, comisionGraficoOpciones);
    graficoComision.render();
    cargarEstadisticasOrdenes('.cantidadOrdenesCompletadas','items',2);
    //
  }

  if ($('.ordenesEnEspera').length) {
    var $graficoMatenimientos = document.querySelector('#order-chart-mantenimientos');  
    var graficoMatenimientos;
    var MatenimientoGraficoOpciones;
    MatenimientoGraficoOpciones = {
      chart: {
        height: 100,
        type: 'area',
        toolbar: {
    ...
    graficoMatenimientos = new ApexCharts($graficoMatenimientos, MatenimientoGraficoOpciones);
    graficoMatenimientos.render();
    cargarEstadisticasOrdenes('.cantidadOrdenesEnEspera','items',1);
    //
  }

  if ($('.ordenesEnProceso').length) {
    var $graficoMatenimientos = document.querySelector('#order-chart-ordenesEnProceso');  
    var graficoMatenimientos;
    var MatenimientoGraficoOpciones;
    MatenimientoGraficoOpciones = {
      chart: {
       ...
       fill: {
        ...
        gradient: {
          ...
          colorStops: [
            {
              offset: 0,
              color: '#02FF34FF', // Rojo intenso
              opacity: 0.7
            },
            {
              offset: 80,
              color: '#07C12CFF', // Rojo medio
              opacity: 0.5
            },
            {
              offset: 100,
              color: '#045514FF', // Rojo oscuro
              opacity: 0.3
            }
          ]
        }
   ...
   if ($('.ordenesADestiempo').length) {
    var $graficoMatenimientos = document.querySelector('#order-chart-ordenesADestiempo');  
    var graficoMatenimientos;
    var MatenimientoGraficoOpciones;
    MatenimientoGraficoOpciones = {
      chart: {
 ...
 $('.btnEditarEmpresa').on('click', function () {
  ...
  $('.btnAddTipo').on('click', function () {
    var $caracteristica = $('.frmAddTipo .txtAddTipo').val(),
      $condicion = $('.frmAddTipo .cmbAddTipoCondicion').val()
  ...
  $('.btnAddMarca').on('click', function () {
    var $marca = $('.frmAddMarca .txtAddMarca').val(),
      $idTipo = $('.frmAddMarca .cmbAddMarca_idTipo').val()
    //frmAddTipo txtAddTipo cmbAddTipoCondicion btnAddTipo
    if (($marca != '') && ($idTipo != '')) {
  ...
  $('.btnAddModelo').on('click', function () {
    var $modelo = $('.frmAddModelo .txtAddModelo').val(),
      $idMarca = $('.frmAddModelo .cmbAddModelo_idMarca').val()
    //frmAddTipo txtAddTipo cmbAddTipoCondicion btnAddTipo
    if (($modelo != '') && ($idMarca != '')) {
  ...
  $('.btnAddVehiculo').on('click', function () {
    ...
    //frmAddTipo txtAddTipo cmbAddTipoCondicion btnAddTipo
    if (($placa != '') && ($idCliente != '0') && ($idModelo != '0') && ($ano != '') && ($color != '') && ($serialChasis != '') && ($serialMotor != '') && ($condicion != '')) {
  ...
  $('.btnAddOrden').on('click', function (e) {

    var $id = $('.idVehiculo').val(),
      $r1 = $('input[name=1]:checked', '#radioRespuestas').val(), $r2 = $('input[name=2]:checked', '#radioRespuestas').val(),
      $r3 = $('input[name=3]:checked', '#radioRespuestas').val(), $r4 = $('input[name=4]:checked', '#radioRespuestas').val(),
      $r5 = $('input[name=5]:checked', '#radioRespuestas').val(), $r6 = $('input[name=6]:checked', '#radioRespuestas').val(),
      $r7 = $('input[name=7]:checked', '#radioRespuestas').val(), $r8 = $('input[name=8]:checked', '#radioRespuestas').val(),
      $r9 = $('input[name=9]:checked', '#radioRespuestas').val(), $r10 = $('input[name=10]:checked', '#radioRespuestas').val(),
      $r11 = $('input[name=11]:checked', '#radioRespuestas').val(), $r12 = $('input[name=12]:checked', '#radioRespuestas').val(),
      $r13 = $('input[name=13]:checked', '#radioRespuestas').val(), $r14 = $('input[name=14]:checked', '#radioRespuestas').val(),
      $r15 = $('input[name=15]:checked', '#radioRespuestas').val(), $r16 = $('input[name=16]:checked', '#radioRespuestas').val(),
      $r17 = $('input[name=17]:checked', '#radioRespuestas').val(), $r18 = $('input[name=18]:checked', '#radioRespuestas').val(),
      $r19 = $('input[name=19]:checked', '#radioRespuestas').val(), $r20 = $('input[name=20]:checked', '#radioRespuestas').val(),
      $asunto = $('.txtAddOrdenAsunto').val(),
      $ruta = $('.txtAddOrdenRuta').val(),
      $idPersonal = $('.cmbAddOrden_idPersonal').val(),
      $idPersonalACargo = $('.cmbAddOrden_idPersonalACargo').val(),
      $observacion = $('.textAreaAddOrdenObservacion').val(),
      $fechaSalida = $('.txtAddOrdenFechaEmision').val(),
      $codigoSalida = $('.txtAddOrden_codigoSalida').val(),
      $idVehiculoCampo = $('.idVehiculo').val(),
      $idVehiculoCombo = $('.cmbAddOrden_idVehiculo').val(),
      $idVehiculo = 0
    if ($idVehiculoCampo == 0) {
      $idVehiculo = $idVehiculoCombo
    } else {
      $idVehiculo = $idVehiculoCampo
    }
    //  console.log(r1);
    if (($asunto != '') && ($ruta != '') && ($idPersonal != '0') && ($idPersonalACargo != '0') && ($observacion != '')
      && ($fechaSalida != '') && ($codigoSalida != '') && ($idVehiculo != '0')) {
      //console.log(id);
      e.preventDefault();
      Swal.fire({
        title: '¿Deseas ordenar Salida?',
        text: "Tenga en cuenta que emitirá una orden de salida de el presente vehiculo, este cambio dejara constancia de movimiento para futuros reportes",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            ...
            type: 'post',
            data: {
              tipo: tipo, accion: accion, datos: datos, idVehiculo: $idVehiculo, asunto: $asunto, ruta: $ruta,
              idPersonal: $idPersonal, idPersonalACargo: $idPersonalACargo, observacion: $observacion, fechaSalida: $fechaSalida, codigoSalida: $codigoSalida,
            ...
            success: function (response) {
              ...
              if (response == '1') {
                Swal.fire({
                  icon: 'success',
                  text: 'Orden de salida registrada con éxito, debe consultarla para emitir el recibo de salida.'
                }),
                window.location = 'index.php?view=ordenes';
  ...
  $.ajax({
    ...
    if (tope == 1) {
      ...
      for (var i = 0; i < tope; i++) {
        ...
        categoria = personal[i].categoria;
        componente = personal[i].componente;
        grado = personal[i].grado;
        cargo = personal[i].cargo;
        idTipo = personal[i].idCategoria;

        dependencia = personal[i].dependencia;
        unidad = personal[i].unidad;
        brigada = personal[i].brigada;
        zodi = personal[i].zodi;
        redi = personal[i].redi;

        gradoLicencia = personal[i].gradoLicencia;
        certificado = personal[i].certificado;


        //$('.dataPersona_foto').prop('src', media);        
        ...
        if (idTipo == '99') {
          $('.dataPersona_tipo').html('CIVIL');

        } else {
          $('.dataPersona_tipo').html('MILITAR');
        }

        $('.dataPersona_categoria').html(categoria);
        $('.dataPersona_componente').html(componente);
        $('.dataPersona_grado').html(grado);
        $('.dataPersona_cargo').html(cargo);
        $('.dataPersona_rango').html(grado);

        $('.dataPersona_licencia').html(gradoLicencia);
        if (idTipo == '1') {
          $('.dataPersona_certificado').html('SI POSEE');
        } else {
          $('.dataPersona_certificado').html('NO POSEE');
        }


        $('.dataPersona_redi').html(redi);
        $('.dataPersona_zodi').html(zodi);
        $('.dataPersona_brigada').html(brigada);
        $('.dataPersona_unidad').html(unidad);
        $('.dataPersona_dependencia').html(dependencia);
...
function cargarTipos($combo, filtro) {
  ...
  $.ajax({
    ...
    if (tope >= 1) {
      ...
      $($combo).html('<option value = "0">No existen Tipos asociados</option>');
    }
    //alert(tope);
  });
}
...
function cargarMarcas($combo, filtro) {
  ...
  $.ajax({
    ...
    if (tope >= 1) {
      ...
      $($combo).html('<option value = "0">No existen Marcas asociados</option>');
    }
    //alert(tope);
  });
}
function cargarModelos($combo, filtro) {
  ...
  $.ajax({
    ...
    if (tope >= 1) {
      ...
      $($combo).html('<option value = "0">No existen Modelos asociados</option>');
    }
    //alert(tope);
  });
}
